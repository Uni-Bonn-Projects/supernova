...
uniform uint uVerticesCount; // deps: raytraycing
uniform uvec3 uIndices[MAX_TRIANGLES]; // deps: raytraycing
uniform vec3 uLightDir; // deps: procedural
uniform vec3 uVertices[MAX_TRIANGLES * 3u * 2u]; // deps: raytraycing
uniform vec3 uNormals[MAX_TRIANGLES * 3u * 2u]; // deps: raytraycing
