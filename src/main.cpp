...
//                           attackerPos, 56.0f);
//     director.moveCameraTo(fightPos + vec3(1200.0f, 500.0f, 1200.0f),
//     fightPos,
//                           201.0f);
//
//     // Init uniforms
...
//     }
//
//     // We already bind the program in the constructor, so we don't need to
//     bind
//     // it again here
//     mesh.draw();
//
...
//       program.set("uNormalEps", uNormalEps);
//
//     if (ImGui::SliderFloat("Camera move speed", &move_speed, 0.1, 100.0,
//     "%.6f",
//                            ImGuiSliderFlags_Logarithmic))
//       program.set("uNormalEps", uNormalEps);
//
